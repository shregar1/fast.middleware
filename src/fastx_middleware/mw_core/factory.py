...
def create_middleware(
    ...
    *,
    ...
    Example:
        ```python
        from fastx_middleware.mw_core.factory import create_middleware
...
def middleware(
    ...
    *,
    ...
    Example:
        ```python
        from fastx_middleware.mw_core.factory import middleware
...
class MiddlewareBuilder:
    ...
    Example:
        ```python
        from fastx_middleware.mw_core.factory import MiddlewareBuilder
...
def add_middleware_once(
    ...
    **kwargs: Any,
    ...
    Example:
        ...
        from fastx_middleware.mw_core.factory import add_middleware_once
...
def quick_middleware(
    ...
    Example:
        ```python
        from fastx_middleware.mw_core.factory import quick_middleware
