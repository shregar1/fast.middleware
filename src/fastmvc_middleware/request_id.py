...
from fastmvc_core.utils.request_id_context import reset_request_id, set_request_id
...
class RequestIDMiddleware(BaseHTTPMiddleware):
    """
    Set ``X-Request-ID`` on the response and bind the value to ``fastmvc_core`` request id context.
